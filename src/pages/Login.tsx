...
export const Login: React.FC = () => {
  ...
  return (
    <div className="max-w-md mx-auto mt-4 sm:mt-8 bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 flex flex-col max-h-[82dvh]">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="relative">
                  ...
                  <select
                    className="w-full pl-10 p-4 border-2 border-gray-300 rounded-lg text-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none bg-white font-medium"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                type="password"
                inputMode="numeric"
                className="w-full pl-12 p-4 border-2 border-gray-300 rounded-lg text-xl font-bold focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none tracking-widest"
